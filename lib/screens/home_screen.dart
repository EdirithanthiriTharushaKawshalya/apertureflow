  ...
  Future<void> _seedInitialData() async {
    try {
      ...
      await widget.repository.addBooking(CalendarEvent(
        ...
        date: day5,
        type: 'Booked Shoot',
        description: 'Studio headshots session - Client: John Doe',
      ));
      ...
      await widget.repository.addBooking(CalendarEvent(
        ...
        description: 'Sony FE 70-200mm f/2.8 GM OSS II',
      ));
      ...
      await widget.repository.addBooking(CalendarEvent(
        ...
        date: day12,
        type: 'Equipment Rental',
        description: 'Profoto Connect Pro trigger',
      ));
      ...
      await widget.repository.addBooking(CalendarEvent(
        ...
        date: day20,
        type: 'Booked Shoot',
        description: 'Corporate event coverage at Grand Hall',
      ));
    } catch (e) {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (event.description != null && event.description!.isNotEmpty) ...[
                                        ...
                                        Text(
                                          event.description!,
                                          style: const TextStyle(color: Color(0xFF767676), fontSize: 11, fontWeight: FontWeight.w500),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      ],
  ...
  Future<void> _openAddEventForm({CalendarEvent? editingEvent}) async {
    ...
    final CalendarEvent? resultEvent = await showDialog<CalendarEvent>(
      ...
      builder: (context) {
        ...
        String description = editingEvent?.description ?? '';
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    const Padding(
                                      ...
                                      child: Icon(Icons.description_outlined, color: Color(0xFF484848), size: 18),
                                    ),
                                    const SizedBox(width: 12),
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        decoration: const InputDecoration(
                                          hintText: 'Add description (client, items, notes)...',
